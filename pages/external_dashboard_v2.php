<?php
$page_title = 'External Affairs Dashboard';
                    ...
                    <div class="max-w-6xl">
                            ...
                            <div class="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-lg p-6 hover:shadow-lg transition-shadow">
                                <div class="flex items-start justify-between">
                                    <div>
                                        ...
                                        <p class="text-green-700 text-xs mt-2">Needed annually</p>
                                    </div>
                        ...
                        <div class="bg-white rounded-lg shadow-md p-6 mb-8">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                                ...
                                <a href="emu_fuel_v2.php" class="p-4 bg-orange-50 hover:bg-orange-100 rounded-lg transition-colors border border-orange-200 text-center">
                        ...
                        <div class="bg-white rounded-lg shadow-md overflow-hidden">
                            ...
                            <?php if (count($activity_records) > 0): ?>
                                <div class="divide-y divide-gray-200">
                                    <?php foreach ($activity_records as $activity): ?>
                                        <div class="px-6 py-4 hover:bg-gray-50 transition-colors">
                                            <div class="flex items-start justify-between">
                                                <div class="flex-1">
                                                    <p class="font-semibold text-gray-800"><?php echo htmlspecialchars($activity['action']); ?></p>
                                                    <p class="text-sm text-gray-600 mt-1"><?php echo htmlspecialchars($activity['report_name']); ?></p>
                                                </div>
                                                <span class="text-xs text-gray-500 whitespace-nowrap ml-4">
                                                    <?php echo Helper::timeAgo($activity['timestamp']); ?>
                                                </span>
                                            </div>
                                        </div>
                                    <?php endforeach; ?>
