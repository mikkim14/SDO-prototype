    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <form method="GET" class="flex gap-4 items-end">
            <div class="flex-1">
                ...
                <select name="campus" class="w-full px-3 py-2 border border-gray-300 rounded-lg">
            ...
            <table class="w-full text-sm" id="elec-table">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase">Price/kWh</th>
                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase">kg CO2/kWh</th>
                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase">t CO2/kWh</th>
                    ...
                    <tr class="bg-white">
                        ...
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="elec-table" data-col="10" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="elec-table" data-col="11" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="elec-table" data-col="12" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="elec-table" data-col="13" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="elec-table" data-col="14" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="elec-table" data-col="15" placeholder="Search..."></th>
                    </tr>
                </thead>
                <tbody class="divide-y">
                    <?php foreach ($electricity_records as $rec): ?>
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2"><?php echo htmlspecialchars($rec['quarter'] ?? '-'); ?></td>
                            ...
                            <td class="px-4 py-2 text-right font-semibold text-blue-700"><?php echo number_format($rec['consumption_in_kwh'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right"><?php echo number_format($rec['multiplier'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right">₱<?php echo number_format($rec['total_amount'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right font-medium"><?php echo number_format($rec['consumption'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right">₱<?php echo number_format($rec['price_per_kwh'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right font-semibold text-green-700"><?php echo number_format($rec['kg_co2_per_kwh'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right font-semibold text-blue-700"><?php echo number_format($rec['t_co2_per_kwh'] ?? 0, 4); ?></td>
                            <td class="px-4 py-2 text-right text-emerald-600"><?php echo number_format($rec['tree_offset'] ?? 0); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
                <tfoot class="bg-gray-50 font-semibold">
                    <tr>
                        <td colspan="11" class="px-4 py-3 text-sm">TOTAL</td>
                        <td class="px-4 py-3 text-sm text-right"><?php echo number_format($total_consumption, 2); ?></td>
                        <td class="px-4 py-3 text-sm"></td>
                        <td class="px-4 py-3 text-sm text-right text-green-700"><?php echo number_format($total_emissions, 2); ?></td>
                        <td class="px-4 py-3 text-sm text-right text-blue-700"><?php echo number_format($total_emissions / 1000, 4); ?></td>
                        <td class="px-4 py-3 text-sm text-right text-emerald-600"><?php echo number_format(ceil($total_emissions / 21)); ?></td>
                    </tr>
                </tfoot>
            </table>
        </div>
