...
<div>
    ...
    <div class="bg-white rounded-lg shadow-md p-4 mb-6">
        <form method="GET" class="flex gap-4 items-end">
            ...
            <?php if ($selected_campus || $selected_year || $selected_category): ?>
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm" id="fuel-table">
                <thead class="bg-gray-50">
                    <tr>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">ID</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Campus</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Date</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Driver</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Type</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Vehicle</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Plate No</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Category</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Fuel Type</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Item Desc</th>
                        <th class="px-2 py-2 text-left text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Trans No</th>
                        <th class="px-2 py-2 text-right text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Odometer</th>
                        <th class="px-2 py-2 text-right text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Qty (L)</th>
                        <th class="px-2 py-2 text-right text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Amount</th>
                        <th class="px-2 py-2 text-right text-xs font-medium text-gray-500 uppercase whitespace-nowrap">CO2</th>
                        <th class="px-2 py-2 text-right text-xs font-medium text-gray-500 uppercase whitespace-nowrap">NH4</th>
                        <th class="px-2 py-2 text-right text-xs font-medium text-gray-500 uppercase whitespace-nowrap">N2O</th>
                        <th class="px-2 py-2 text-right text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Total (kg)</th>
                        <th class="px-2 py-2 text-right text-xs font-medium text-gray-500 uppercase whitespace-nowrap">Total (t)</th>
                    </tr>
                    <tr class="bg-white">
                        ...
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="7" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="8" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="9" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="10" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="11" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="12" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="13" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="14" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="15" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="16" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="17" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="fuel-table" data-col="18" placeholder="Search..."></th>
                    </tr>
                </thead>
                <tbody class="divide-y">
                    <?php foreach ($fuel_records as $rec): ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-2 py-2 text-xs"><?php echo htmlspecialchars($rec['id'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs whitespace-nowrap"><?php echo htmlspecialchars($rec['campus'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs whitespace-nowrap"><?php echo htmlspecialchars($rec['date'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs whitespace-nowrap"><?php echo htmlspecialchars($rec['driver'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs whitespace-nowrap"><?php echo htmlspecialchars($rec['type'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs whitespace-nowrap"><?php echo htmlspecialchars($rec['vehicle_equipment'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs whitespace-nowrap"><?php echo htmlspecialchars($rec['plate_no'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs whitespace-nowrap"><?php echo htmlspecialchars($rec['category'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs whitespace-nowrap"><?php echo htmlspecialchars($rec['fuel_type'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs max-w-xs truncate" title="<?php echo htmlspecialchars($rec['item_description'] ?? ''); ?>"><?php echo htmlspecialchars($rec['item_description'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs whitespace-nowrap"><?php echo htmlspecialchars($rec['transaction_no'] ?? ''); ?></td>
                            <td class="px-2 py-2 text-xs text-right whitespace-nowrap"><?php echo number_format($rec['odometer'] ?? 0); ?></td>
                            <td class="px-2 py-2 text-xs text-right font-medium whitespace-nowrap"><?php echo number_format($rec['quantity_liters'] ?? 0, 2); ?></td>
                            <td class="px-2 py-2 text-xs text-right whitespace-nowrap">₱<?php echo number_format($rec['total_amount'] ?? 0, 2); ?></td>
                            <td class="px-2 py-2 text-xs text-right whitespace-nowrap"><?php echo number_format($rec['co2_emission'] ?? 0, 2); ?></td>
                            <td class="px-2 py-2 text-xs text-right whitespace-nowrap"><?php echo number_format($rec['nh4_emission'] ?? 0, 2); ?></td>
                            <td class="px-2 py-2 text-xs text-right whitespace-nowrap"><?php echo number_format($rec['n2o_emission'] ?? 0, 2); ?></td>
                            <td class="px-2 py-2 text-xs text-right font-semibold text-green-700 whitespace-nowrap"><?php echo number_format($rec['total_emission'] ?? 0, 2); ?></td>
                            <td class="px-2 py-2 text-xs text-right font-semibold text-blue-700 whitespace-nowrap"><?php echo number_format($rec['total_emission_t'] ?? 0, 4); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
            ...
            <table class="w-full text-sm" id="lpg-table">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase">Tank Weight (kg)</th>
                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase">Tank Volume (L)</th>
                        ...
                        <th class="px-4 py-2 text-right text-xs font-medium text-gray-500 uppercase">GHG (t CO2e)</th>
                    </tr>
                    <tr class="bg-white">
                        ...
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="lpg-table" data-col="8" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="lpg-table" data-col="9" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="lpg-table" data-col="10" placeholder="Search..."></th>
                        <th class="px-2 py-1"><input type="text" class="w-full px-2 py-1 text-xs border rounded filter-input" data-table="lpg-table" data-col="11" placeholder="Search..."></th>
                    </tr>
                </thead>
                <tbody class="divide-y">
                    <?php foreach ($lpg_records as $rec): ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-4 py-2"><?php echo htmlspecialchars($rec['id'] ?? ''); ?></td>
                            ...
                            <td class="px-4 py-2 text-right"><?php echo number_format($rec['TankWeight'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right"><?php echo number_format($rec['TankVolume'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right font-medium"><?php echo number_format($rec['TotalTankVolume'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right font-semibold text-green-700"><?php echo number_format($rec['GHGEmissionKGCO2e'] ?? 0, 2); ?></td>
                            <td class="px-4 py-2 text-right font-semibold text-blue-700"><?php echo number_format($rec['GHGEmissionTCO2e'] ?? 0, 4); ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
