<?php
$page_title = 'Category Report - GSO';
require_once 'tailwind-header.php';

$category = $_GET['cat'] ?? 'fuel';
$selected_campus = $user['campus'];
$selected_year = $_GET['year'] ?? null;

// Category configuration
$category_config = [
    'fuel' => ['name' => 'Fuel', 'icon' => 'fa-gas-pump', 'color' => 'orange', 'table' => 'fuel_emissions', 'year_col' => 'YEAR(date)'],
];

$config = $category_config[$category] ?? $category_config['fuel'];
